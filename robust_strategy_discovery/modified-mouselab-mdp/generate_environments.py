...
reward_arr = [level_types[0],level_types[0],level_types[0]]

branching = [3, 3, 3]
env=[MouselabEnv.new_symmetric(branching, reward_arr, seed=1, cost=1, sample_term_reward=False, env_type='new',repeat_cost=2),
MouselabEnv.new_symmetric(branching, reward_arr, seed=2, cost=1, sample_term_reward=False, env_type='new',repeat_cost=2)]
