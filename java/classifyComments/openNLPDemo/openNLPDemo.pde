...
void setup() {
  ...
  try {
    ...
    //modelIn = new FileInputStream("Desktop/processing/classifyComments/openNLPDemo/en-token.bin");
...
public static void POSTag() throws IOException {
  POSModel model = new POSModelLoader().load(new File("Desktop/processing/classifyComments/openNLPDemo/en-pos-maxent.bin"));
