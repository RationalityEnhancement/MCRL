...
experiment_nr =  1.5 #0.991  # pilot experiment with low-cost and i.i.d. rewards
...
switch experiment_nr
  ...
  when 1.5 then IVs = {frequencyOfFB : ['after_each_move'], PRTypes: ['none','featureBased','objectLevel'], messageTypes: ['full','none'],infoCosts: [0.25,1.00,4.00]}    
  ...
  when 4 then IVs = {frequencyOfFB : ['after_each_move'], PRTypes: ['none'], messageTypes: ['full'],infoCosts: [1.00]}
