...
experiment_nr = 0.97  # pilot experiment with low-cost and i.i.d. rewards
...
switch experiment_nr
  ...
  when 0.97 then IVs = {frequencyOfFB : ['after_each_move'], PRTypes: ['none'], messageTypes: ['none'],infoCosts: [0.01]}    
