...
function predictQValue(state,computation){
    ...
    switch(PARAMS.info_cost){
        case 0.01:
            feature_weights = {allActionsVPI: 1.1456, VPI: 0.0150, VOC1: 0.2675, cost: -0.0346, ER: 0.7593, offset: 3.3601} //otherVPIs: [0.3230, -0.6466, -0.5869]
            ...
            break;
        case 1.0:
            feature_weights = {allActionsVPI: -0.7316, VPI: 1.2236, VOC1: 1.2386, cost: -2.0801, ER: 0.9734, offset: 1.9350}//{allActionsVPI: 1.2895, VPI: 0.0858, VOC1: 0.4536, cost: -2.6655, ER: 0.9791, offset: 4.8433} //otherVPIs: [-0.3154, -0.4761, -0.5306]
            ...
            break;
        case 2.5:
            feature_weights = {allActionsVPI: -0.2200, VPI: 0.2670, VOC1: 0.2378, cost: -1.0069, ER: 0.6550, offset: 1.0737}//{allActionsVPI: -0.1546, VPI: 0.1337, VOC1: 0.0981, cost: -1.4057, ER: 0.9330, offset: 0.1887} //otherVPIs: [-0.4179, 0.5560, 1.4445]
