filename=['../data/03242018/DataExp',int2str(experiment_nr),'JSON.csv'];
filename_metadata=['../data/03242018/MetaDataExp',int2str(experiment_nr),'.csv']
...
save(['../data/Mouselab_data_Experiment',int2str(experiment_nr),'.mat'], 'data_by_sub','data')
