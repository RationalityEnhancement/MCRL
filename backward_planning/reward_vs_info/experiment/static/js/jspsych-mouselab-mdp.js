...
jsPsych.plugins['mouselab-mdp'] = (function() {
  ...
  MouselabMDP = class MouselabMDP {
    ...
    async showFeedback(action) {
      var a, defaultMessage, delay, i, j, l, len, len1, len2, loss, msg, optimal, q, qs, ref, ref1, ref2, s, strictness, v;
      ...
      if (this._block.show_feedback) {
        ...
        if (with_info && !with_reward) {
          if (ref1 = this.termAction, indexOf.call(optimal, ref1) >= 0) {
            msg = "The optimal strategy would have stopped clicking and started moving.";
          } else {
            msg = "The optimal strategy would have inspected one of the highlighted nodes.          ";
      ...
      this.freeze = false;
      if (ref2 = this.termAction, indexOf.call(optimal, ref2) < 0) {
        for (l = 0, len2 = optimal.length; l < len2; l++) {
          s = optimal[l];
